 ...
 * 
 */
@WebServiceClient(name = "UserServiceService", targetNamespace = "http://service.mayikt.com/", wsdlLocation = "http://127.0.0.1:8089/service/UserService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName USERSERVICESERVICE_QNAME = new QName("http://service.mayikt.com/", "UserServiceService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://127.0.0.1:8089/service/UserService?wsdl");
    ...
    public UserService getUserServicePort() {
        return super.getPort(new QName("http://service.mayikt.com/", "UserServicePort"), UserService.class);
    }
    ...
    public UserService getUserServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://service.mayikt.com/", "UserServicePort"), UserService.class, features);
    }
